                ...
                <div class="card-body pb-2">
                    <form action="{{ route('saleStore') }}" method="POST">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <input type="text" class="form-control" name="fuel_litter" id="fuel_litter" value="{{ old('fuel_litter') }}"required />
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <input type="text" class="form-control" name="per_litter_price" id="per_litter_price" value="{{ old('per_litter_price') }}"required />

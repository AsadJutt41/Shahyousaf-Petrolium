        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Petrol Volume/Stock</h3>
                </div>
                <div class="card-body pb-2">
                    <form action="{{ route('stockUpdate' , ['id'=>$stock->id]) }}" method="POST">
                        @csrf
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <input type="text" class="form-control" name="fuel_litter" id="fuel_litter" value="{{ $stock->fuel_litter }}" required />
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <input type="text" class="form-control" name="per_litter_price" id="per_litter_price" value="{{ $stock->per_litter_price }}" required />

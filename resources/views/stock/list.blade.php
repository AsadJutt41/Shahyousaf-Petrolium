            ...
            <div class="modal-body">
                <form id="stockForm">
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <input type="text" class="form-control" name="fuel_litter" id="fuel_litter" required />
                        <span class="text-danger" id="fuel_litterErrorMsg"></span>
                    </div>

                    <div class="col-md-12 mt-3">
                        <label for="" class="label-control">Per Litter Price</label>
                        <input type="text" class="form-control" name="per_litter_price" id="per_litter_price" required />
